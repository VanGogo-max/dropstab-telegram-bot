...
class StrategyAutoSelector:
    ...
    def _score_strategy(
        ...
        if strategy == StrategyType.GRID:
            # Good for: ranging markets, low volatility
            if volatility == 'low':
                score += 20
        ...
        # ===== DCA STRATEGY =====
            ...
            # Good for: all conditions, beginners
            score += 15  # Always decent
            
            if experience == 'beginner':
                score += 20
            
            if not can_monitor:
                score += 15  # Set and forget
        ...
        # ===== AGGRESSIVE SCALPER =====
            ...
            # Good for: high volatility, can monitor
            if volatility == 'high':
                score += 25
        ...
        # ===== MEAN REVERSION =====
            ...
            # Good for: ranging, low volatility
            if volatility == 'low':
                score += 15
    ...
    def _get_market_data(self, symbol: str = 'BTC/USDT') -> List[Dict]:
        """
        Get market data for analysis
        This is a placeholder - implement with real exchange API
        """
        logger.warning("Using mock market data - implement real exchange integration")
